...
{
    public class UserRepository : Repository<Entities.User>, IUserRepository, IScopedDependency
    {
        ...
        {
            //ser.MySecurityStamp = Guid.NewGuid();
            return UpdateAsync(user, cancellationToken);
        }

       // public override void Update(User entity, bool saveNow = true)
       // {
            //entity.MySecurityStamp = Guid.NewGuid();
